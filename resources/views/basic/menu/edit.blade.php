...
@section('page-content')
    ...
    <div class="row">
        <div class="col-xs-6">
            ...
            {{ Form::bsSelect('permission_id', '绑定权限',$model->permission_id,$menuPresenter->fillPermissions($permissions))}}
            {{ Form::bsSelect('parent_id', '父结点',$model->parent_id,$menuPresenter->fillMenus($menus))}}
